...
namespace ego_planner
{
  ...
  private:
    ...
    double perching_approach_velocity_alpha_{0.35};
    double perching_min_prediction_time_{1.0};
    double perching_max_prediction_time_{5.0};
    double perching_terminal_thrust_{9.81};
    double perching_terminal_thrust_range_{2.0};
    bool perching_use_dynamics_terminal_accel_{true};
    bool perching_override_target_orientation_{false};
    bool perching_replan_if_unsafe_{true};
    double perching_arrive_pos_thresh_{0.20};
    double perching_arrive_vel_thresh_{0.45};
    double perching_min_execute_time_{0.30};
    double perching_stage_entry_hold_time_{0.20};
    double perching_entry_tangent_vel_thresh_{0.25};
    double perching_commit_distance_thresh_{0.45};
    double perching_commit_rel_vel_thresh_{0.25};
    double perching_commit_tangent_vel_thresh_{0.15};
    double perching_commit_normal_speed_min_{0.03};
    double perching_commit_normal_speed_max_{0.65};
    ...
    double frozen_perching_wall_time_{-1.0};
    ...
    runtime::PerchingTerminalState frozen_perching_terminal_;
    double frozen_perching_reference_time_{0.0};
    Eigen::Vector3d frozen_surface_tangent_x_{Eigen::Vector3d::UnitX()};
    Eigen::Vector3d frozen_surface_tangent_y_{Eigen::Vector3d::UnitY()};

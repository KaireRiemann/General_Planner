...
public:
  ...
  // Compatibility helpers are kept public so legacy tracking/perching paths can
  // reuse the same solver-side state-to-state construction owner instead of
  // reimplementing these algorithms in planner_manager.

...
namespace ego_planner
{
  ...
  void PolyTrajOptimizer::setParam(ros::NodeHandle &nh)
  {
    ...
    nh.param("optimization/weight_perching_floor", wei_perching_floor_, 100000.0);
    ...
    nh.param("optimization/perching_relative_normal_speed_tolerance", perching_check_config_.relative_normal_speed_tolerance, 0.55);
